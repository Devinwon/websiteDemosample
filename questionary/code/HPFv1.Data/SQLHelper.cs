...
namespace HPFv1.Data
{
    ...
    public  class SqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        protected static string _connectionstring = HPFv1.Core.Security.GetConnectionStr(ConfigurationManager.ConnectionStrings["SQLConnectionString"].ToString());	// 数据库连接串-格式(中文为用户修改的内容)：Data Source=数据库服务器地址;UserPassword ID=您的数据库用户名;Password=您的数据库用户密码;Initial Catalog=数据库名称;Pooling=true

        //public static string _connectionstring = ConfigurationManager.ConnectionStrings["SQLConnectionString"].ToString();
        ...
        /// <param name="commandType">命令类型 (存储过程,命令文本, 其它.)</param>
        /// <param name="commandText">一个存储过程名或SQL命令</param>
        /// <returns>返回结果是一个DataSet</returns>
        ...
        /// <param name="commandType">命令类型 存储过程或者是SQL命令</param>
        /// <param name="commandText">存储过程名或SQL命令</param>
        /// <returns>结果返回一个SqlDataReader</returns>
