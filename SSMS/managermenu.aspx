<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="managermenu.aspx.cs" 
    Inherits="managermenu" Title="欢迎使用学生成绩管理系统" StyleSheetTheme="Blue" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%;align-content:center;" >
        ...
        <tr>
            <td style="width: 20%; height: 400px; background-color: aliceblue">
                <asp:TreeView ID="TreeView1" runat="server" Font-Bold="True" Font-Names="仿宋"
                    ...
                    <Nodes>
                        ...
                        <asp:TreeNode Text="密码管理" Value="我的密码管理" NavigateUrl="~/dispinfo.aspx?info=欢迎使用本系统" Target="Iframe1">
                            <asp:TreeNode Text="更改密码" Value="更改我的密码" Target="Iframe1" NavigateUrl="~/Manager/updatemanagerpass.aspx"></asp:TreeNode>
                        </asp:TreeNode>
                    </Nodes>
                </asp:TreeView>
