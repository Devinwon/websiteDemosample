        ...
        */
        ...
        $.fn.GridView = function (callGridview) {
            ...
            gridview = $.extend({
                ...
                template: '<a class="gallery-item" href="/Projects/Detail/?id=yoyotui_pid" title="yoyotui_title" data-gallery><div class="image"><img src="yoyotui_img" alt="yoyotui_title" /></div><div class="meta"><strong> yoyotui_title </strong></div></a>',
        ...
        function _fnSplicing(_arrDatas) {
            ...
            for (var i = 0, ien = _arrDatas.length ; i < ien ; i++) {
                ...
                tempRow = tempRow.replace(/yoyotui_pid/g, _arrDatas[i].yoyotui_pid);
