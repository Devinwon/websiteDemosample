...
namespace HPStudent.Data
{
    ...
    public class SqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        protected static string _connectionstring = HPStudent.Core.Security.GetConnectionStr(ConfigurationManager.ConnectionStrings["sqlconn"].ToString());	// 数据库连接串-格式(中文为用户修改的内容)：Data Source=数据库服务器地址;UserPassword ID=您的数据库用户名;Password=您的数据库用户密码;Initial Catalog=数据库名称;Pooling=true
